 ...
 * given 0-indexed array edges of size n, indicating that there is a directed edge 
...
class Solution2359 {
    ...
    public static void main(String[] args){
        ...
        final int[] edges = new int[]{1,2,3,4};
        System.out.println("ANS: " + s.closestMeetingNode( edges, 5, 5));
    }
}
